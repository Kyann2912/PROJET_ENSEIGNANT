  ...
  <body>
    <div class="container-fluid">
        <div class="A mt-5 mb-4">
            <h1 class="text-center text-primary">LISTE DES FILIÈRES</h1>
            <hr>

            <!-- Section de gestion des filières -->
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="/filiere" class="btn btn-success">AJOUTER UNE FILIÈRE</a>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/modifier/filiere/{{ $filiere->id }}" class="btn btn-info btn-sm">MODIFIER</a>
                                <a href="/supprimer/filiere/{{ $filiere->id }}" class="btn btn-danger btn-sm">SUPPRIMER</a>
                            </td>
                        </tr>
                        @php $yann++; @endphp
                        @endforeach
